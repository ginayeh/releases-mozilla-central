...
BluetoothDBusService::StartInternal()
{
  ...
  LOG("[B] Register agent signal handler");
  ...
  LOG("[B] mLiveManagers.Length() = %d", mLiveManagers.Length());
                                          ...
                                          BluetoothReplyRunnable* aRunnable)
{
  ...
  nsRefPtr<nsRunnable> func(new CreateBluetoothSocketRunnable(runnable, aSocketConsumer,
                                                              aObjectPath,
                                                              aService, aType,
                                                              aAuth, aEncrypt));
  if (NS_FAILED(mBluetoothCommandThread->Dispatch(func, NS_DISPATCH_NORMAL))) {
...
public:
  ...
  Run()
  {
    LOG("[B] CloseBluetoothSocketRunnable::Run");
    BluetoothValue v;
    nsString replyError;
